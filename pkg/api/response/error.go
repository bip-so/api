...
// BadDataErrorWithFieldAndData means the request has invalid field and states reason
...
func RecordDoesNotExistError(ctx context.Context, description string) Error {
...
const NoPermissionError = "NoPermissionError"
